...
public class Exercise2Test extends PetDomainForKata
{
    ...
    {
        Person result = this.people.select(person -> person.getPets()
                .anySatisfy(pet -> pet.getName().equals("Tabby"))).get(0);
    ...
    public void getAllPetsOfAllPeople()
    {
        ...
        MutableSet<PetType> petTypes = Sets.mutable.ofAll(this.people.flatCollect(function));
        Assert.assertEquals(
